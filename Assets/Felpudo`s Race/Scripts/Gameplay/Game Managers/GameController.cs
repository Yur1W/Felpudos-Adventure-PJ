...
public class GameController : MonoBehaviour
{
    ...
    [SerializeField]
    GameObject BossIruca;
    [SerializeField]
    GameObject FelpudoCinematic;
    [SerializeField]
    GameObject FelpudoCar;
    ...
    {   lives = 3;
        ...
        StartCoroutine(ui.HideTutorial());

        if (BossIruca != null)
        {
            bossLevel = true;
            ui.ShowBossLife(true);
            ui.UpdateBossLife(bossLife);
        }
    }
    ...
    void Victory()
    {
        ...
        {
            StartCoroutine(WaitVictoryCoroutine());
        }
    }
    ...
    {
        yield return new WaitForSeconds(1f);
        FelpudoCar.SetActive(false);
        FelpudoCinematic.SetActive(true);

        //playerCode.animator.Play("OnFoot");
    }
    IEnumerator WaitVictoryCoroutine()
    {
